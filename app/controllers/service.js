...
.factory('AuthService',['$rootScope','$http','$window','$location', function ($rootScope, $http, $window, $location) {
  ...
  // $rootScope.keystone_adminid = "52562a38b5d347bab9d81be0aec6ea48";
    ...
    .then(function(data){
        ...
        $http.defaults.headers.common['X-Auth-Token'] = data.data['access']['token']['id'];
        $http.get(keystone_url+'/tenants').then(function(data){
            credentials['auth']['tenantName'] = data.data['tenants'][0]['name']
            var tenantInfo = data.data;
            ...
            .then(function(data){
              ...
              var servis = data.data.access.serviceCatalog;
              ...
              defalutapp = defaultdatas[0];
                data.data['access']['tenants'] = tenantInfo['tenants'];
                $window.sessionStorage.setItem("userInfo", JSON.stringify(data.data));
                window.sessionStorage.setItem("islogin",JSON.stringify(data.data));
